" Name:       nope.vim
" Version:    0.1
" Maintainer: github.com/bogwonch
...
call s:h("Identifier",    {"gui": "bold,italic"})
hi! link Function         Identifier

call s:h("Statement",     {"gui": "bold"})
...
call s:h("PreProc",       {"gui": "italic"})
hi! link Include          PreProc
hi! link Define           PreProc
hi! link Macro            PreProc
hi! link PreCondit        PreProc

call s:h("Type",          {"gui": "NONE"})
hi! link StorageClass     Type
hi! link Structure        Type
hi! link Typedef          Type

call s:h("Special",       {"fg": s:bg_subtle})
...
if has("gui_running")
  ...
  call s:h("SpellLocal",  {"gui": "undercurl", "sp": s:red})
else
  call s:h("SpellBad",    {"cterm": "undercurl", "fg": s:red})
  call s:h("SpellCap",    {"cterm": "undercurl", "fg": s:red})
  call s:h("SpellRare",   {"cterm": "undercurl", "fg": s:red})
  call s:h("SpellLocal",  {"cterm": "undercurl", "fg": s:red})
endif
